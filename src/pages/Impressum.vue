  ...
  <Layout>
    <section class="my-12 mx-auto sm:w-3/4 w-4/5">
      ...
      <section>
        ...
        <p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO), ist:</p><br>
        <b>Geschäftsinhaber</b><br>
        Marcel Kleewein<br>
        Glasstraße 65<br>
        50823 Köln<br>        <h2>Ihre Betroffenenrechte</h2>
